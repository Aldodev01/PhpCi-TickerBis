...
const Print = ({navigation}) => {
  const urler = "https://res.cloudinary.com/aldodevv/image/upload/v1655714844/logo_v5nabx.svg"
    ...
    <View>
      ...
      {ordered.length === 0 ? (
        ...
        <Text style={{marginTop: 40}}>
          Maaf!, Anda Belum Memiliki Tiket <Button
      ...
      <Text style={styles.judul}>  <Gap Gop={20} />Daftar Tiket Anda :</Text>
      <Gap Gap={20} />
        {ordered.map((e, i) => {
          return (
            <Card key={i}>
